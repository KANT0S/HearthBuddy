    ...
    public static class CultureManager
    {
        ...
        internal static void smethod_1()
        {
            if (notifyIcon_0 == null)
            {
                ...
                notifyIcon_0.MouseClick += new MouseEventHandler(CultureManager.smethod_5);
                notifyIcon_0.MouseDoubleClick += new MouseEventHandler(CultureManager.smethod_6);
                notifyIcon_0.Text = "Select";
                ContextMenuStrip strip = new ContextMenuStrip();
                strip.Items.Add(new ToolStripSeparator());
                ToolStripMenuItem item = new ToolStripMenuItem("Other Cultures");
                item.Click += new EventHandler(CultureManager.smethod_7);
        ...
        private static void smethod_2()
        {
            if (cultureSelectWindow_0 == null)
            {
                ...
                cultureSelectWindow_0.Closed += new EventHandler(CultureManager.smethod_9);
        ...
        private static void smethod_3(ContextMenuStrip contextMenuStrip_0)
        {
            ...
            item.CheckedChanged += new EventHandler(CultureManager.smethod_8);
