namespace Triton.Game.Mapping
{
    ...
    [Attribute38("CardBurstEpic")]
    public class CardBurstEpic : Spell
    {
        public CardBurstEpic(IntPtr address) : this(address, "CardBurstEpic")
        {
        }

        public CardBurstEpic(IntPtr address, string className) : base(address, className)
        {
        }
