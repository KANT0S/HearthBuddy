namespace Triton.Game.Mapping
{
    ...
    [Attribute38("DraftDeckTray")]
    public class DraftDeckTray : MonoBehaviour
    {
        public DraftDeckTray(IntPtr address) : this(address, "DraftDeckTray")
        {
        }

        public DraftDeckTray(IntPtr address, string className) : base(address, className)
        {
        }

        public void AddCard(string cardID, Actor animateFromActor)
        {
            object[] objArray1 = new object[] { cardID, animateFromActor };
        ...
        {
            return MonoClass.smethod_15<DraftDeckTray>(TritonHs.MainAssemblyPath, "", "DraftDeckTray", "Get", Array.Empty<object>());
        }
        ...
        {
            object[] objArray1 = new object[] { draftDeck };
            base.method_8("OnDraftDeckInitialized", objArray1);
        }
