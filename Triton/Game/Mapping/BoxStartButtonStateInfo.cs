namespace Triton.Game.Mapping
{
    ...
    [Attribute38("BoxStartButtonStateInfo")]
    public class BoxStartButtonStateInfo : MonoClass
    {
        public BoxStartButtonStateInfo(IntPtr address) : this(address, "BoxStartButtonStateInfo")
        {
        }

        public BoxStartButtonStateInfo(IntPtr address, string className) : base(address, className)
        {
        }
