namespace Triton.Game.Mapping
{
    ...
    [Attribute38("TwistingNetherSqueezeInfo")]
    public class TwistingNetherSqueezeInfo : MonoClass
    {
        public TwistingNetherSqueezeInfo(IntPtr address) : this(address, "TwistingNetherSqueezeInfo")
        {
        }

        public TwistingNetherSqueezeInfo(IntPtr address, string className) : base(address, className)
        {
        }
