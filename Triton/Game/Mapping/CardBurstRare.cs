namespace Triton.Game.Mapping
{
    ...
    [Attribute38("CardBurstRare")]
    public class CardBurstRare : Spell
    {
        public CardBurstRare(IntPtr address) : this(address, "CardBurstRare")
        {
        }

        public CardBurstRare(IntPtr address, string className) : base(address, className)
        {
        }
