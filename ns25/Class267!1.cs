namespace ns25
{
    ...
    internal class Class267<T> : MonoClass where T: class
    {
        internal Class267(IntPtr address) : base(TritonHs.MainAssemblyDir + @"\mscorlib.dll", "System.Collections.Generic", "List<" + typeof(T).FullName + ">")
        {
        ...
        public T method_24(int int_1)
        {
            ...
            return base.method_15<T>("get_Item", enumArray1, objArray1);
        }
