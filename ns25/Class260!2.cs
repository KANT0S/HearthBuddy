namespace ns25
{
    ...
    internal class Class260<T, U> : MonoClass where T: class where U: class
    {
        internal Class260(IntPtr address) : base(TritonHs.MainAssemblyDir + @"\mscorlib.dll", "System.Collections.Generic", "IEnumerator<" + typeof(T).FullName + ", " + typeof(U).FullName + ">")
        {
