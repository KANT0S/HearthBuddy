namespace ns25
{
    ...
    {
        internal Class253(IntPtr address) : base(TritonHs.MainAssemblyDir + @"\mscorlib.dll", "System.Collections.Generic", "Dictionary<" + typeof(T).FullName + ", " + typeof(string).FullName + ">")
        {
            base.Address = address;
            base.UInt32_0 = MonoClass.Class272_0.method_10(address, true);
        }

        private Class262<T> method_24()
        {
            return base.method_14<Class262<T>>(Class271.string_0, Array.Empty<object>());
        }

        public Dictionary<T, string> method_25()
        {
            Dictionary<T, string> dictionary = new Dictionary<T, string>();
            Class262<T> class2 = this.method_24();
