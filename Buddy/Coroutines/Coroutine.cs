System.InvalidOperationException: Operation is not valid due to the current state of the object.
   at ..(String typeName, String assemblyReference)
   at ..(String fullyQualifiedName)
   at ..( reader)
   at ..( reader, String namespaceName, String name)
   at ..( reader, IType type)
   at ..get_Arguments()
   at ..(ICustomAttribute value)
   at ..(ICustomAttributeCollection attributes)
   at ..(IMethodDeclaration value)
   at ..(IMethodDeclarationCollection methods)
   at ..(ITypeDeclaration value)
   at ..(ITypeDeclarationCollection value)
   at ..(ITypeDeclaration value)
   at ..(ITypeDeclaration value)
